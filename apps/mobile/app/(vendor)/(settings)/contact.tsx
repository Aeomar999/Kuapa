      ...
      <ScrollView className="flex-1 px-5 pt-6 pb-12" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-card rounded-2xl border border-border p-5 gap-4">
          <View>
            ...
            <Pressable className="bg-background border border-border rounded-lg p-4 flex-row justify-between items-center">
              <Text className="text-body-lg text-foreground">Payouts & Earnings</Text>
              <Icon name="chevron-down" size={20} color="#94a3b8" />
            </Pressable>
          </View>

          <Input label="Order ID (Optional)" placeholder="e.g. ORD-9821" />
          ...
          <Pressable className="border-2 border-dashed border-border rounded-lg p-4 items-center justify-center bg-background mt-2">
            <Icon name="paperclip" size={20} color="#64748b" style={{ marginBottom: 4 }} />
            <Text className="text-sm font-bold text-muted-foreground mt-1">Attach Screenshot</Text>
          </Pressable>
        </View>
